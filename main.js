...
function createTable() {
    ...
    for (var i = 0; i < rows; i++) {
        ...
        for (var j = 0; j < columns; j++) {
            ...
            cell.setAttribute("input", updateCell);
            rowData.push("");
...
function updateCell(event) {
    var rowsInput = event.target.perentNode.rowIndex - 1;
    var colsInput = event.target.cellIndex;
    var value = event.target.textContent.trim();
    updateData(rowIndex, colsIndex, value);
}
